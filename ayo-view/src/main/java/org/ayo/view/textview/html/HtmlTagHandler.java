...
public class HtmlTagHandler {
    ...
    public static Spanned fromHtml(String source, Html.ImageGetter getter, AyoTagHandler tagHandler){
        HtmlToSpannedConverter h = new HtmlToSpannedConverter(source, getter, tagHandler);
        Spanned s = h.convert();
        return s;
    }

    public static interface AyoTagHandler {
    ...
    static class HtmlToSpannedConverter implements ContentHandler {
        ...
        private AyoTagHandler mTagHandler;

        public HtmlToSpannedConverter(String source, Html.ImageGetter imageGetter, AyoTagHandler taghandler) {
            mSource = source;
